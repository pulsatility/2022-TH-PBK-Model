...
% Liver T4 blood supply rate (pmol/S)
...
% Liver T3 blood supply rate (pmol/S)
...
% RB T4 blood supply rate (pmol/S)
...
% RB T3 blood supply rate (pmol/S)
...
Percent_LiverT3_influx = LiverT3_influx_rate/(totalT3B*param.QL);
