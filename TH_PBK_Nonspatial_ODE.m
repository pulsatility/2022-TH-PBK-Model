function dydt = TH_PBK_Nonspatial_ODE(t, y, option, param)
...
%fT4B 
dydt(1) = -k1*fT4B*TBGB + k2*T4TBGB - k3*fT4B*TTRB + k4*T4TTRB - k5*fT4B*ALBB + k6*T4ALBB + (fT4T*QT + fT4RB*QRB + fT4L*QL - fT4B*QC)/VB;
...
%fT3B
dydt(5) = -k7*fT3B*TBGB + k8*T3TBGB - k9*fT3B*TTRB + k10*T3TTRB - k11*fT3B*ALBB + k12*T3ALBB + (fT3T*QT + fT3RB*QRB + fT3L*QL - fT3B*QC)/VB;
